...
def main():
    ...
    if not Path(config_file).is_file():
        raise ValueError('Please go to https://huggingface.co/jackyqs/vits-aishell3-175-chinese/tree/main to download config.json')

    if not Path(checkpoint).is_file():
        raise ValueError('Please go to https://huggingface.co/jackyqs/vits-aishell3-175-chinese/tree/main to download G_AISHELL.pth')
    ...
    save_wav(audio, "./test.wav", hps.data.sampling_rate)
